...
export const metadata = { title: "Termos de Uso — SafeMind NR-01" };
  ...
  return (
    <div className="min-h-screen bg-[#0F0A1A] text-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-[#E9D5FF] font-[var(--font-sora)]">Termos de Uso</h1>
          <p className="text-[#9CA3AF] mt-2 text-sm">Última atualização: maio de 2026</p>
        </div>

        <Section title="1. Aceitação dos Termos">
          <p>
            Ao acessar ou utilizar a plataforma SafeMind NR-01 ("Serviço"), você ("Empresa" ou "Usuário") concorda com estes
        ...
        <Section title="2. Descrição do Serviço">
          <p>
            A SafeMind NR-01 é uma plataforma SaaS que oferece ferramentas para gestão de saúde mental organizacional, pesquisas
            de clima anônimas, canal de denúncias, planos de ação e monitoramento de conformidade com a NR-01 (Portaria MTE nº
            765/2025).
          </p>
          <p className="mt-3">
            O Serviço é contratado pela empresa ("Controladora de dados") para uso interno com seus colaboradores. A SafeMind atua
        ...
        <Section title="3. Acesso e Credenciais">
          <p>
            O acesso à plataforma é fornecido exclusivamente por credenciais criadas pela SafeMind ou pelo administrador autorizado
        ...
        <Section title="8. Propriedade Intelectual">
          <p>
            Todos os direitos sobre a plataforma, código-fonte, design e conteúdo pertencem à SafeMind. Os dados inseridos
            pela Empresa contratante permanecem de sua propriedade. A SafeMind não reivindica propriedade sobre dados dos
        ...
        <Section title="9. Disponibilidade e Suporte">
          <p>
            A SafeMind emprega esforços razoáveis para manter o Serviço disponível continuamente, mas não garante disponibilidade
        ...
        <Section title="10. Limitação de Responsabilidade">
          <p>
            Na máxima extensão permitida pela lei, a SafeMind não será responsável por danos indiretos, incidentais ou
            consequenciais decorrentes do uso ou da impossibilidade de uso do Serviço. A responsabilidade total da SafeMind
        ...
        <Section title="12. Alterações">
          <p>
            A SafeMind pode atualizar estes Termos periodicamente. Alterações relevantes serão comunicadas por e-mail ou por
        ...
        <Section title="13. Lei Aplicável e Foro">
          <p>
            ...
            [Cidade/Estado da SafeMind] para resolução de quaisquer disputas, com renúncia a qualquer outro, por mais
            privilegiado que seja.
          </p>
        </Section>

        <div className="border-t border-purple-500/10 pt-6 text-center">
          <Link href="/privacidade" className="text-xs text-purple-400 hover:underline">Política de Privacidade</Link>
